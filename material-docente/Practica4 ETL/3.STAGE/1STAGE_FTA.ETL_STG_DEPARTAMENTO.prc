CREATE OR REPLACE PROCEDURE ETL_STG_DEPARTAMENTO  IS

  -- VARIABLES GENERALES
--DECLARE 
  V_NOMBRE_PROCESO   VARCHAR2(30):= 'ETL_STG_DEPARTAMENTO';
  V_FEC_INICIO       DATE;
  V_FEC_FIN          DATE;
...
BEGIN
  ...
  -- CODIGO DEL PROCESO
    ...
    EXECUTE IMMEDIATE 'TRUNCATE TABLE STG_DEPARTAMENTO';
    INSERT INTO STG_DEPARTAMENTO (ID_DEPTO,NOM_DEPTO)
    SELECT ID_DEPTO,NOM_DEPTO FROM DISTRIBUIDOR.DEPARTAMENTOS;
