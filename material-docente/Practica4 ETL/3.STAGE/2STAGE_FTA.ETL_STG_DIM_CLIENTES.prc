...
BEGIN
  ...
  -- CODIGO DEL PROCESO
    ...
    INSERT INTO STG_DIM_CLIENTES 
                (IDW_CLIENTES, ID_CLIENTE, NOMBRE, AP_PATERNO,
                  AP_MATERNO, CI, ID_SUBRUBRO, SUBRUBRO, ID_RUBRO, 
                  RUBRO, ID_CANAL_SISTEMA, START_DATE, END_DATE, FLAG, USER_DW)
