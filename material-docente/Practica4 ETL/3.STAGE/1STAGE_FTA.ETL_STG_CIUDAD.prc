CREATE OR REPLACE PROCEDURE ETL_STG_CIUDAD  IS

  -- VARIABLES GENERALES
--DECLARE 
  V_NOMBRE_PROCESO   VARCHAR2(30):= 'ETL_STG_CIUDAD';
  V_FEC_INICIO       DATE;
  V_FEC_FIN          DATE;
...
BEGIN
  ...
  -- CODIGO DEL PROCESO
    ...
    EXECUTE IMMEDIATE 'TRUNCATE TABLE STG_CIUDADES';
    INSERT INTO STG_CIUDADES (ID_DEPTO,ID_CIUDAD,NOM_CIUDAD)
    SELECT ID_DEPTO,ID_CIUDAD,NOM_CIUDAD FROM DISTRIBUIDOR.CIUDADES;
