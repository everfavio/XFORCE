...
-- creando la funcion
create or replace function one_etl_stage_customers()
returns boolean
as $$ 
  --para errores
  ...
  BEGIN
    ...
    nombre_proceso = 'one_etl_stage_customers';
    cantidad_registros = 0;
    -- limpieza de suppliers
    truncate table  stage_trans_customers;
    insert into stage_trans_customers (
      customerid  ,
      address     ,
      postalcode  ,
      phone       ,
...
-- select * from stage_trans_customers;
