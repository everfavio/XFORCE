...
-- creando la funcion
create or replace function one_etl_stage_products()
returns boolean
as $$ 
  --para errores
  ...
  BEGIN
    ...
    nombre_proceso = 'one_etl_stage_products';
    cantidad_registros = 0;
    -- limpieza
    truncate table  stage_trans_products;
    insert into stage_trans_products (
      productid      ,
      productname    ,
      quantityperunit,
      unitprice      ,
...
-- select * from stage_trans_products;
