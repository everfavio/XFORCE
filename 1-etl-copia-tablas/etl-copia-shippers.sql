...
-- creando la funcion
create or replace function one_etl_stage_shippers()
returns boolean
as $$ 
  --para errores
  ...
  BEGIN
    ...
    nombre_proceso = 'one_etl_stage_shippers';
    cantidad_registros = 0;
    -- limpieza 
    truncate table  stage_trans_shippers;
    insert into stage_trans_shippers (
      shipperid  ,
      companyname,
      phone      
    )
...
-- select * from stage_trans_shippers;
