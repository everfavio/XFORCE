...
-- creando la funcion
create or replace function one_etl_stage_orderdetails()
returns boolean
as $$ 
  --para errores
  ...
  BEGIN
    ...
    nombre_proceso = 'one_etl_stage_orderdetails';
    cantidad_registros = 0;
    -- limpieza
    truncate table  stage_trans_orderdetails;
    insert into stage_trans_orderdetails (
        orderdetailid,
        productid    ,
        orderid      ,
        unitprice    ,
...
-- select * from stage_trans_orderdetails;
