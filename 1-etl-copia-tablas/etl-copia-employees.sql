...
-- creando la funcion
create or replace function one_etl_stage_employees()
returns boolean
as $$ 
  --para errores
  ...
  BEGIN
    ...
    nombre_proceso = 'one_etl_stage_employees';
    cantidad_registros = 0;
    -- limpieza de suppliers
    truncate table  stage_trans_employees;
    insert into stage_trans_employees (
      employeeid     ,
      lastname       ,
      firstname      ,
      title          ,
